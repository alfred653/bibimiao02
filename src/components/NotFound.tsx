...
export default function NotFound() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', fontSize: '12px', marginBottom: '24px' }}>The page you're looking for doesn't exist</p>
      <Link
        to="/"
        style={{ background: 'var(--bg-active)', color: 'var(--text-inverse)', padding: '8px 24px', fontSize: '13px', fontWeight: 700, textTransform: 'uppercase', textDecoration: 'none', border: 'none', cursor: 'pointer' }}
      >
        Back to Home
      </Link>
    </div>
